...
# 3. Extract JWT from Authorization header and decode it
...
# 4. Dependency: Extract fleet_id from JWT payload
def get_fleet_id(request: Request) -> int:
...
# 5. For /login route: dummy authentication (replace with DB lookup later)
